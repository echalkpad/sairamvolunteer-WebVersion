  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.findById() instead.
        "prototype$__findById__registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
          method: "GET"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.destroyById() instead.
        "prototype$__destroyById__registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.updateById() instead.
        "prototype$__updateById__registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents() instead.
        "prototype$__get__registeredvolunteerevents": {
          isArray: true,
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "GET"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.create() instead.
        "prototype$__create__registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "POST"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.destroyAll() instead.
        "prototype$__delete__registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.count() instead.
        "prototype$__count__registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Volunteerevents.customers.findById() instead.
        "::findById::volunteerevents::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/customers/:fk",
          method: "GET"
        },

        // INTERNAL. Use Volunteerevents.customers.destroyById() instead.
        "::destroyById::volunteerevents::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/customers/:fk",
        ...
        // INTERNAL. Use Volunteerevents.customers.updateById() instead.
        "::updateById::volunteerevents::customers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/customers/:fk",
        ...
        // INTERNAL. Use Volunteerevents.customers() instead.
        "::get::volunteerevents::customers": {
          isArray: true,
          url: urlBase + "/volunteerevents/:id/customers",
          method: "GET"
        },

        // INTERNAL. Use Volunteerevents.customers.create() instead.
        "::create::volunteerevents::customers": {
          url: urlBase + "/volunteerevents/:id/customers",
          method: "POST"
        },

        // INTERNAL. Use Volunteerevents.customers.createMany() instead.
        "::createMany::volunteerevents::customers": {
          isArray: true,
          url: urlBase + "/volunteerevents/:id/customers",
          method: "POST"
        },

        // INTERNAL. Use Volunteerevents.customers.destroyAll() instead.
        "::delete::volunteerevents::customers": {
          url: urlBase + "/volunteerevents/:id/customers",
          method: "DELETE"
        },

        // INTERNAL. Use Volunteerevents.customers.count() instead.
        "::count::volunteerevents::customers": {
          url: urlBase + "/volunteerevents/:id/customers/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Registeredevents.customer() instead.
        "::get::registeredevents::customer": {
          url: urlBase + "/registeredevents/:id/customer",
          method: "GET"
        },

        // INTERNAL. Use Registeredvolunteerevents.customer() instead.
        "::get::registeredvolunteerevents::customer": {
          url: urlBase + "/registeredvolunteerevents/:id/customer",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customer.registeredvolunteerevents
     * @header lbServices.Customer.registeredvolunteerevents
     * @object
     * @description
     *
     * The object `Customer.registeredvolunteerevents` groups methods
     * manipulating `Registeredvolunteerevents` instances related to `Customer`.
     *
     * Call {@link lbServices.Customer#registeredvolunteerevents Customer.registeredvolunteerevents()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries registeredvolunteerevents of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Registeredvolunteerevents` object.)
         * </em>
         */
        R.registeredvolunteerevents = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::get::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#count
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Counts registeredvolunteerevents of Customer.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        R.registeredvolunteerevents.count = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::count::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#create
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Creates a new instance in registeredvolunteerevents of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.registeredvolunteerevents.create = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::create::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#createMany
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         ...
         * </em>
         */
        R.registeredvolunteerevents.createMany = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::createMany::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#destroyAll
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Deletes all registeredvolunteerevents of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.registeredvolunteerevents.destroyAll = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::delete::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#destroyById
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Delete a related item by id for registeredvolunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for registeredvolunteerevents
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.registeredvolunteerevents.destroyById = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::destroyById::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#findById
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Find a related item by id for registeredvolunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.registeredvolunteerevents.findById = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::findById::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Customer.registeredvolunteerevents#updateById
         * @methodOf lbServices.Customer.registeredvolunteerevents
         *
         * @description
         *
         * Update a related item by id for registeredvolunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.registeredvolunteerevents.updateById = function() {
          var TargetResource = $injector.get("Registeredvolunteerevents");
          var action = TargetResource["::updateById::Customer::registeredvolunteerevents"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Volunteerevents
 * @header lbServices.Volunteerevents
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Volunteerevents` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Volunteerevents.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/comments/:fk",
          method: "GET"
        },

        // INTERNAL. Use Volunteerevents.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Volunteerevents.comments.updateById() instead.
        "prototype$__updateById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Volunteerevents.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
          url: urlBase + "/volunteerevents/:id/comments",
          method: "GET"
        },

        // INTERNAL. Use Volunteerevents.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/volunteerevents/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Volunteerevents.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/volunteerevents/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Volunteerevents.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/volunteerevents/:id/comments/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#create
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/volunteerevents",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#createMany
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#upsert
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#exists
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/volunteerevents/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#findById
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/volunteerevents/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#find
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#findOne
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/volunteerevents/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#updateAll
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/volunteerevents/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#deleteById
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#count
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/volunteerevents/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#prototype$updateAttributes
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#createChangeStream
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        "::get::Comments::volunteerevents": {
          url: urlBase + "/Comments/:id/volunteerevents",
          method: "GET"
        },

        // INTERNAL. Use Favorites.volunteerevents() instead.
        "::get::Favorites::volunteerevents": {
          url: urlBase + "/Favorites/:id/volunteerevents",
          method: "GET"
        },

        // INTERNAL. Use Registeredevents.volunteerevents() instead.
        "::get::registeredevents::volunteerevents": {
          url: urlBase + "/registeredevents/:id/volunteerevents",
          method: "GET"
        },

        // INTERNAL. Use Registeredvolunteerevents.volunteerevents() instead.
        "::get::registeredvolunteerevents::volunteerevents": {
          url: urlBase + "/registeredvolunteerevents/:id/volunteerevents",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#updateOrCreate
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#update
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#destroyById
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents#removeById
         * @methodOf lbServices.Volunteerevents
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Volunteerevents#modelName
    * @propertyOf lbServices.Volunteerevents
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Volunteerevents`.
    */
    R.modelName = "Volunteerevents";

    /**
     * @ngdoc object
     * @name lbServices.Volunteerevents.customers
     * @header lbServices.Volunteerevents.customers
     * @object
     * @description
     *
     * The object `Volunteerevents.customers` groups methods
     * manipulating `Customer` instances related to `Volunteerevents`.
     *
     * Call {@link lbServices.Volunteerevents#customers Volunteerevents.customers()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries customers of volunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers = function() {
          ...
          var action = TargetResource["::get::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#count
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
         * Counts customers of volunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers.count = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::count::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#create
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.create = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::create::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#createMany
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.createMany = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::createMany::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#destroyAll
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.destroyAll = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::delete::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#destroyById
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.destroyById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::destroyById::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#findById
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.findById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::findById::volunteerevents::customers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.customers#updateById
         * @methodOf lbServices.Volunteerevents.customers
         *
         * @description
         *
        ...
        R.customers.updateById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::updateById::volunteerevents::customers"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Volunteerevents.comments
     * @header lbServices.Volunteerevents.comments
     * @object
     * @description
     *
     * The object `Volunteerevents.comments` groups methods
     * manipulating `Comments` instances related to `Volunteerevents`.
     *
     * Call {@link lbServices.Volunteerevents#comments Volunteerevents.comments()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries comments of volunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::get::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#count
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
         * Counts comments of volunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::count::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#create
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::create::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#createMany
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::createMany::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#destroyAll
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::delete::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#destroyById
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::destroyById::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#findById
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::findById::volunteerevents::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Volunteerevents.comments#updateById
         * @methodOf lbServices.Volunteerevents.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comments");
          var action = TargetResource["::updateById::volunteerevents::comments"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Comments.volunteerevents() instead.
        "prototype$__get__volunteerevents": {
          url: urlBase + "/Comments/:id/volunteerevents",
          method: "GET"
        },
        ...
        // INTERNAL. Use Volunteerevents.comments.findById() instead.
        "::findById::volunteerevents::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/comments/:fk",
        ...
        // INTERNAL. Use Volunteerevents.comments.destroyById() instead.
        "::destroyById::volunteerevents::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/comments/:fk",
        ...
        // INTERNAL. Use Volunteerevents.comments.updateById() instead.
        "::updateById::volunteerevents::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/volunteerevents/:id/comments/:fk",
        ...
        // INTERNAL. Use Volunteerevents.comments.create() instead.
        "::create::volunteerevents::comments": {
          url: urlBase + "/volunteerevents/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Volunteerevents.comments.createMany() instead.
        "::createMany::volunteerevents::comments": {
          isArray: true,
          url: urlBase + "/volunteerevents/:id/comments",
          method: "POST"
        },
        ...
        // INTERNAL. Use Volunteerevents.comments.destroyAll() instead.
        "::delete::volunteerevents::comments": {
          url: urlBase + "/volunteerevents/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Volunteerevents.comments.count() instead.
        "::count::volunteerevents::comments": {
          url: urlBase + "/volunteerevents/:id/comments/count",
          method: "GET"
        },
      }
    ...
    */
    R.modelName = "Comments";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Comments#volunteerevents
         * @methodOf lbServices.Comments
         *
         * @description
         *
         * Fetches belongsTo relation volunteerevents.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.volunteerevents = function() {
          var TargetResource = $injector.get("Volunteerevents");
          var action = TargetResource["::get::Comments::volunteerevents"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Favorites";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Favorites#volunteerevents
         * @methodOf lbServices.Favorites
         *
         * @description
         *
        ...
        R.volunteerevents = function() {
          var TargetResource = $injector.get("Volunteerevents");
          var action = TargetResource["::get::Favorites::volunteerevents"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Registeredevents
 * @header lbServices.Registeredevents
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Registeredevents` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#create
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Registeredevents` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/registeredevents",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#createMany
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#upsert
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#exists
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/registeredevents/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#findById
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/registeredevents/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#find
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#findOne
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/registeredevents/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#updateAll
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/registeredevents/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#deleteById
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#count
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/registeredevents/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#prototype$updateAttributes
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#createChangeStream
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/registeredevents/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#updateOrCreate
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#update
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#destroyById
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#removeById
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Registeredevents#modelName
    * @propertyOf lbServices.Registeredevents
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Registeredevents`.
    */
    R.modelName = "Registeredevents";


        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#customer
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        R.customer = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::registeredevents::customer"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Registeredevents#volunteerevents
         * @methodOf lbServices.Registeredevents
         *
         * @description
         *
        ...
        R.volunteerevents = function() {
          var TargetResource = $injector.get("Volunteerevents");
          var action = TargetResource["::get::registeredevents::volunteerevents"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Registeredvolunteerevents
 * @header lbServices.Registeredvolunteerevents
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Registeredvolunteerevents` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/registeredvolunteerevents/:id",
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#create
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/registeredvolunteerevents",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#createMany
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#upsert
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#exists
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/registeredvolunteerevents/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#findById
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/registeredvolunteerevents/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#find
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#findOne
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/registeredvolunteerevents/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#updateAll
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/registeredvolunteerevents/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#deleteById
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#count
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/registeredvolunteerevents/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#prototype$updateAttributes
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#createChangeStream
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/registeredvolunteerevents/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.findById() instead.
        "::findById::Customer::registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.destroyById() instead.
        "::destroyById::Customer::registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.updateById() instead.
        "::updateById::Customer::registeredvolunteerevents": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Customers/:id/registeredvolunteerevents/:fk",
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents() instead.
        "::get::Customer::registeredvolunteerevents": {
          isArray: true,
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "GET"
        },
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.create() instead.
        "::create::Customer::registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "POST"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.createMany() instead.
        "::createMany::Customer::registeredvolunteerevents": {
          isArray: true,
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "POST"
        },
        ...
        // INTERNAL. Use Customer.registeredvolunteerevents.destroyAll() instead.
        "::delete::Customer::registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents",
          method: "DELETE"
        },

        // INTERNAL. Use Customer.registeredvolunteerevents.count() instead.
        "::count::Customer::registeredvolunteerevents": {
          url: urlBase + "/Customers/:id/registeredvolunteerevents/count",
          method: "GET"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#updateOrCreate
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#update
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#destroyById
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#removeById
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Registeredvolunteerevents#modelName
    * @propertyOf lbServices.Registeredvolunteerevents
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Registeredvolunteerevents`.
    */
    R.modelName = "Registeredvolunteerevents";


        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#customer
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        R.customer = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::get::registeredvolunteerevents::customer"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Registeredvolunteerevents#volunteerevents
         * @methodOf lbServices.Registeredvolunteerevents
         *
         * @description
         *
        ...
        R.volunteerevents = function() {
          var TargetResource = $injector.get("Volunteerevents");
          var action = TargetResource["::get::registeredvolunteerevents::volunteerevents"];
          return action.apply(R, arguments);
        };
